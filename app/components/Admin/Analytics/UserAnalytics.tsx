        ...
        <>
            {
                isLoading ? (
                    ...
                    <div className={`${isDashboard ? "mt-[50px]" : " dark:bg-[#111c43] shadow-sm pb-5 rounded-sm"}`}>
                        <div className={`${isDashboard ? "!ml-8 mb-5" : "pt-[50px]"}`}>
                        ...
                        <div className={`w-full ${isDashboard ? "h-[30vh]" : "h-screen"} flex items-center justify-center`}>
                            <ResponsiveContainer width={isDashboard ? "100%" : "90%"} height={isDashboard ? "50%" : "60%"}>
                                <AreaChart
                                    data={analyticsData}
                                    margin={{
                                        top: 20,
