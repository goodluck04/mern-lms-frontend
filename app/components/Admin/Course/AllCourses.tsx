            ...
            {open && (
              ...
              >
                ...
                >
                  ...
                  <div
                    className='flex w-full items-center justify-between mb-6 mt-6'
                  >
                    <div
                      className={`${styles.button} !w-[120px] h-[30px] bg-green-300`}
                      onClick={() => setOpen(!open)}
                    >
                      Cancel
                    </div>
                    <div
                      className={`${styles.button} !w-[120px] h-[30px] bg-red-400`}
