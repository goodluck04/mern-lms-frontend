...
const Hero: FC<Props> = (props) => {
    ...
    return (
        <div className="w-full 1000px:flex items-center">
            {/* not complete css */}
            <div className='absolute top-[10px] 1000px:top-[unset] 1500px:h-[700px] 1500px:w-[700px] 1100px:h-[500px] 1100px:w-[500px] h-[50vh] hero_animation rounded-[50%] 1100px:left-[2rem] 1500px:left-[4rem]'></div>
