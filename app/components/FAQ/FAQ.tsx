...
const FAQ = (props: Props) => {
    ...
    return (
        <div className='w-[90%] 800px:w-[80%] m-auto py-8'>
            ...
            <div className='mt-12'>
                <dl className='space-y-8'>
                    {questions.map((q) => (
                        <div key={q._id} className={`${q._id !== questions[0]?._id && "border-t"
                            } border-gray-200 pt-6`}>
                            <dt className='text-lg'>
                                <button
                                    className='flex items-center justify-between w-full text-left focus:outline'
